...
export default function UpcomingRegistrationCard({ race }) {
  return (
    <Link
      ...
      className="registration-card-horizontal"
    >
      {/* Image section with badges overlay */}
      <div className="registration-card-image-container">
        ...
        <div className="registration-card-image-badges">
          {race.terrain && (
      ...
      {/* Content section */}
      <div className="registration-card-content-horizontal">
        <div className="registration-card-header">
          <h2 className="registration-card-title-horizontal">
            {race.name}
            <span className="registration-card-distance-inline">
              {race.distance === "∞" ? race.distance : `${race.distance}km`}
            </span>
          </h2>
          
          {/* Icons inline with title */}
          <div className="registration-card-icons-inline">
            {race.medal && (
        ...
        <div className="registration-card-info-horizontal">
          <p className="registration-card-race-date-horizontal">
            <strong>Race Date:</strong> {formatDate(race.date)}
          </p>
          
          {race.earlyBirdCost && (
            <p className="registration-card-price-horizontal">
              <strong>Early Bird:</strong>{" "}
              <span className="race-card-registration-cost">{race.earlyBirdCost}</span>
              {" "}
              <span className="registration-card-dates">
